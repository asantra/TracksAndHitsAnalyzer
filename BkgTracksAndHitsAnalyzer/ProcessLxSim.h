...
protected:
  TChain       *fHitChain;
  LxHitsTree   *fHitTree;
  Long64_t      fHitTreeEntry;
  Long64_t      fHitTreeEntries;
  std::vector<LxHits> fHits;
  int fEventId;
  
  TChain           *fHitTrackChain;
  LxHittracksTree  *fHitTrackTree;
  Long64_t          fHitTrackTreeEntry;
  Long64_t          fHitTrackTreeEntries;
  std::vector<LxHittracks> fHitTracks;
  int fEventHitTrackId;
  
  TChain           *fTrackChain;
  LxTracksTree     *fTrackTree;
  Long64_t          fTrackTreeEntry;
  Long64_t          fTrackTreeEntries;
